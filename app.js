...
// Wipe stored fortune data immediately
if (window.creationStorage && window.creationStorage.plain) {
    window.creationStorage.plain.removeItem('fortune_data')
        .then(() => console.log("Old fortune_data cleared"))
        .catch(err => console.error("Failed to clear fortune_data:", err));
}
